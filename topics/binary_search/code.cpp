...
int main(){ fofo
    ...
    // lower_bound: retorna um iterador para o primeiro elemento que não é menor do que X
    // upper_bound: retorna um iterador para o primeiro elemento maior que X.
    ...
    if(it == v.end())
        cout << "Nao encontrado" << it - v.begin() << endl;
    else
